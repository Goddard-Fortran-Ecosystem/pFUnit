module pf_Real64RelationalMatcher
   use iso_fortran_env
   ...
   interface less_than_or_equal_to
      module procedure :: less_than_or_equal_to_real64
   end interface less_than_or_equal_to

   interface greater_than
      module procedure :: greater_than_real64
   end interface greater_than

   interface greater_than_or_equal_to
      module procedure :: greater_than_or_equal_to_real64
...
contains
   ...
   function greater_than_or_equal_to_real64(operand) result(matcher)
      ...
      call matcher%super('>=', operand)
   end function greater_than_or_equal_to_real64
...
end module pf_Real64RelationalMatcher