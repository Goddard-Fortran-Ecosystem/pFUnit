...
module pf_IsLess
   ...
   type, extends(BaseMatcher) :: IsLess
      private
...
contains
   ...
   subroutine describe_to(this, description)
      ...
      call description%append_text("integer or real value strictly less than ")
   ...
   subroutine describe_numeric_mismatch(this, actual, description)
      ...
      call description%append_value(actual)
      call description%append_text(" is greater than or equal to ")
      call description%append_value(this%expected_value)
