module pf_Int32RelationalMatcher
   ...
   interface less_than_or_equal_to
      module procedure :: less_than_or_equal_to_int32
   end interface less_than_or_equal_to

   interface greater_than
      module procedure :: greater_than_int32
   end interface greater_than

   interface greater_than_or_equal_to
      module procedure :: greater_than_or_equal_to_int32
...
contains
   ...
   function greater_than_or_equal_to_int32(operand) result(matcher)
      ...
      call matcher%super('>=', operand)
   end function greater_than_or_equal_to_int32
