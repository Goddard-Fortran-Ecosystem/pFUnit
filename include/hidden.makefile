...
PFUNIT_LFLAGS+= $(PFUNIT_WRAP_OBJECTS) $(PFUNIT_TEST_OBJECTS)
PFUNIT_LFLAGS+= -L$(PFUNIT)/lib -lpfunit
PFUNIT_LFLAGS+= $(PFUNIT_APP_OBJECTS)
...
$(PFUNIT_TEST_EXECUTABLE): $(PFUNIT_TESTS_OBJECTS) $(PFUNIT_WRAP_OBJECTS) $(PFUNIT_SUITE_LIST)
	$(PFUNIT_COMPILER) -o $@ $($(PFUNIT_FFLAGS_VARIABLE)) $(PFUNIT)/include/driver.F90 $(PFUNIT_LFLAGS)
